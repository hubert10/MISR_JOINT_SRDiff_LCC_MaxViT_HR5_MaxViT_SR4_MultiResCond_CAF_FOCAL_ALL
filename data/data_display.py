...
def filter_dates(
    img, mask, clouds: bool = 2, area_threshold: float = 0.2, proba_threshold: int = 20
):
    """Mask : array T*2*H*W
...
def display_wow_samples(
    ...
    img_idx = "D:/kanyamahanga/Datasets/FLAIR_2_toy_dataset/flair_aerial_train/D055_2018/Z14_UF/img/IMG_037470.tif"
    sen_idx = "D:/kanyamahanga/Datasets/FLAIR_2_toy_dataset/flair_sen_train/D055_2018/Z14_UF/sen/SEN2_sp_D055_2018-Z14_UF_data.npy"
    msk_idx = "D:/kanyamahanga/Datasets/FLAIR_2_toy_dataset/flair_labels_train/D055_2018/Z14_UF/msk/MSK_037470.tif"
